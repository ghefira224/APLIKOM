...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-001.png}
...
>plot3d("x^2+y^2"):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-008.png}
\begin{eulerprompt}
>function f(r) := exp(-r/2)*cos(r); ...
>plot3d("f(x^2+y^2)",>polar,scale=[1,1,0.4],r=2pi,frame=3,zoom=4):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-011.png}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-012.png}
\begin{eulerprompt}
>plot3d("exp(x*y)",angle=100°,>contour,color=green):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-014.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-015.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-018.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-024.png}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-025.png}
\begin{eulerprompt}
>plot3d("x^2+y^2+4*x*z+z^3",>implicit,r=2,zoom=2.5):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-026.png}
...
>scale=1.4,height=50°):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-032.png}
\begin{eulerprompt}
>t=linspace(0,4pi,1000); plot3d(cos(t),sin(t),t/2pi,>wire, ...
>linewidth=3,wirecolor=blue):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-033.png}
\begin{eulerprompt}
>X=cumsum(normal(3,100)); ...
> plot3d(X[1],X[2],X[3],>anaglyph,>wire):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-038.png}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-041.png}
\begin{eulerprompt}
>Z=intrandom(5,100,6); v=zeros(5,6); ...
>loop 1 to 5; v[#]=getmultiplicities(1:6,Z[#]); end; ...
>columnsplot3d(v',scols=1:5,ccols=[1:5]):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-042.png}
...
>level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-043.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-047.png}
...
\end{eulerprompt}
\eulerimg{17}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-048.png}
\begin{eulercomment}
...
>myplot(x,y,z):
\end{eulerprompt}
\eulerimg{27}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-049.png}
...
\end{eulerprompt}
\eulerimg{27}{images/3. Ghefira Nur Annisa_22305144034(Plot 3D)-050.png}
...
\begin{euleroutput}
  ...
  Try list ... to find functions!
  Error in:
  ... ,zoom=5,w=450,h=350,   <shadow,look=povlook(gray),   xv=&"dn[1 ...
                                                       ^
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Variable povx not found!
  Error in:
  c1=povcylinder(-povx,povx,1,povlook(red)); c2=povcylinder(-pov ...
                      ^
\end{euleroutput}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Try list ... to find functions!
  onebox:
      useglobal; return povbox([x,y,z],[x+d,y+d,z+d],povlook()); 
  fractal:
      if n==1 then writeln(onebox(x,y,z,h));
  fractal:
      fractal(x,y,z,h,n-1);
...
\begin{euleroutput}
  ...
  Try list ... to find functions!
  Error in:
  c2=povobject("mycube",povlook(yellow),translate=[1,1,1],   rot ...
                                       ^
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Function writeAxis not found.
  Try list ... to find functions!
  Error in:
  writeAxis(-1.2,1.2,axis=1); writeAxis(-1.2,1.2,axis=2); writeA ...
                            ^
\end{euleroutput}
...
\begin{euleroutput}
  ...
  Try list ... to find functions!
  Error in:
  ... ace("pow(x,2)*y-pow(y,3)-pow(z,2)",povlook(green))); writeAxes ...
                                                       ^
\end{euleroutput}
...
\end{eulerprompt}
\begin{euleroutput}
  Function povtriangles not found.
  Try list ... to find functions!
  Error in:
  mesh=povtriangles(x,y,z,"",vx,vy,vz); ...
                                      ^
...
\end{eulerprompt}
\begin{euleroutput}
  Function povdisc not found.
  Try list ... to find functions!
  Error in:
  cl=povdisc([0.5,0.5,0],[1,1,0],2); ll=povdisc([0,0,1/4],[0,0,1 ...
                                   ^
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Variable or function mesh not found.
  Error in:
  writeln(povdifference(mesh,povunion([cl,ll]),povlook(green))); ...
                            ^
\end{euleroutput}
...
\end{eulerprompt}
\begin{euleroutput}
  Variable mesh not found!
  Error in:
  writeln(povintersection([mesh,cl],povlook(red))); writeln(povi ...
                               ^
\end{euleroutput}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Try list ... to find functions!
  Error in:
  writeln(povpoint([1/2,1/2,1/4],povlook(gray),size=2*defaultpoi ...
                                              ^
\end{euleroutput}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Try list ... to find functions!
  Error in:
  ... eight=45°,>anaglyph,   center=[0,0,0.5],zoom=3.5); ...
                                                       ^
\end{euleroutput}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Try list ... to find functions!
  Error in:
  ... inear Problem",[0,0.2,1.3],size=0.05,rotate=125°)); povend(); ...
                                                       ^
\end{euleroutput}
...
\begin{euleroutput}
  ...
  Try list ... to find functions!
  Error in:
  povstart(zoom=3); x=-1:0.5:1; r=1-(x+1)^3/6; t=(0°:30°:360°)'; ...
                  ^
\end{euleroutput}
\end{eulernotebook}
