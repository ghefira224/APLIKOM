...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-003.png}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-005.png}
\begin{eulercomment}
...
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-006.png}
...
\]
\end{eulerformula}
\eulerimg{1}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-008-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-014-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-018.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-020.png}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-025.png}
\begin{eulerprompt}
>sol &= solve([x^2+y^2=b^2,(x-a)^2+y^2=c^2],[x,y])
\end{eulerprompt}
\begin{euleroutput}
...
\]
\end{eulerformula}
\eulerimg{0}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-029-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-030.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-035-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-038.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-042-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-055.png}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-058.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-061-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-064-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-065.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{1}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-070-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-074.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-077-large.png}
\eulerimg{0}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-078-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-081-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-089-large.png}
...
\]
\end{eulerformula}
\eulerimg{0}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-093-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-095.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-097-large.png}
\eulerimg{1}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-098-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-100.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-103.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-107.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-108.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-109.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-111.png}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-112.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-113.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-114.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-115.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-116.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-118.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-119.png}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-120.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-124.png}
...
\end{eulerprompt}
\begin{euleroutput}
  Variable or function vp not found.
  Error in:
  writeln(povplane(vp,dp,povlook(blue,0.5),pc)); ...
                     ^
\end{euleroutput}
...
\end{eulerprompt}
\begin{euleroutput}
  Variable or function P2 not found.
  Error in:
  writeln(povpoint(P2,povlook(yellow))); ...
                     ^
\end{euleroutput}
...
\end{eulerprompt}
\begin{euleroutput}
  Global variable a not found in "global" command.
  scene:
      global a,u,dd,g,g1,defaultpointsize;
  Try "trace errors" to inspect local variables after errors.
  povanaglyph:
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-126.png}
...
\begin{eulerformula}
\[
\left[ \frac{7}{4} , \frac{7}{4} , \frac{5}{2^{\frac{3}{2}}}
  \right] 
\]
\end{eulerformula}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\left[ \frac{\sqrt{2}\,\sqrt{10}+2}{4} , \frac{\sqrt{2}\,\sqrt{10}+
 2}{4} \right] 
\]
\end{eulerformula}
\begin{eulerprompt}
...
>plotPoint(P1); plotPoint(P2):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-137.png}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
>c &= circleWithCenter(A,4) // lingkaran dengan pusat A jari-jari 4
...
\begin{eulerformula}
\[
\left[ \left[ \frac{\sqrt{23}+7}{2} , \frac{3-\sqrt{23}}{2}
  \right]  , \left[ \frac{7-\sqrt{23}}{2} , \frac{\sqrt{23}+3}{2}
  \right]  \right] 
\]
\end{eulerformula}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-139.png}
\eulersubheading{ Garis Sumbu}
\begin{eulerprompt}
>A=[3,3]; B=[-2,-3];
>c1=circleWithCenter(A,distance(A,B));
...
>plotPoint(A); plotPoint(B); plotSegment(A,B); plotLine(l):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-140.png}
\begin{eulerprompt}
>A &= [a1,a2]; B &= [b1,b2];
>c1 &= circleWithCenter(A,distance(A,B));
>c2 &= circleWithCenter(B,distance(A,B));
...
>plotSegment(A,B,""); plotSegment(B,C,""); plotSegment(C,A,""):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-144.png}
\begin{eulerprompt}
>$areaTriangle(A,B,C)
\end{eulerprompt}
\begin{eulerformula}
...
\begin{eulerformula}
\[
\frac{\sqrt{2}\,\left(\frac{9\,y}{2}-\frac{3\,x}{2}+\frac{9}{2}
 \right)}{3\,\sqrt{5}}
\]
\end{eulerformula}
\begin{eulerformula}
...
\begin{eulerformula}
\[
\left(y-\frac{15}{28}\right)^2+\left(x-\frac{9}{28}\right)^2=\frac{
 2925}{392}
\]
\end{eulerformula}
\begin{eulerprompt}
...
>plotCircle(LL()); plotPoint(O(),"O"):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-151.png}
\begin{eulerprompt}
>H &= lineIntersection(perpendicular(A,lineThrough(C,B)),...
>  perpendicular(B,lineThrough(A,C))); $H
\end{eulerprompt}
...
>plotPoint(H(),"H"); plotLine(el(),"Garis Euler"):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-154.png}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
>M &= (A+B+C)/3; $getLineEquation(el,x,y) with [x=M[1],y=M[2]]
...
>plotPoint(M(),"M"): // titik berat
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-156.png}
\begin{eulerprompt}
>$distance(M,H)/distance(M,O)|radcan
\end{eulerprompt}
\begin{eulerformula}
...
\begin{eulerformula}
\[
\left[ \frac{\left(3\,2^{\frac{3}{2}}+3\right)\,\sqrt{5}\,\sqrt{13}
 -45\,\sqrt{2}+9}{28} , \frac{\left(3\,\sqrt{2}-9\right)\,\sqrt{5}\,
 \sqrt{13}+15\,2^{\frac{3}{2}}+15}{28} \right] 
\]
\end{eulerformula}
\begin{eulerprompt}
>r &= distance(Q,projectToLine(Q,lineThrough(A,B)))|ratsimp; $r
...
\begin{eulerformula}
\[
\frac{\sqrt{\left(-369\,\sqrt{2}-279\right)\,\sqrt{5}\,\sqrt{13}+
 1035\,\sqrt{2}+5526}}{7\,2^{\frac{3}{2}}}
\]
\end{eulerformula}
\begin{eulerprompt}
>LD &=  circleWithCenter(Q,r); // Lingkaran dalam
...
>color(5); plotCircle(LD()):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-161.png}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-162.png}
\begin{eulerprompt}
>$distance(A,B)
\end{eulerprompt}
\begin{eulerformula}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-176.png}
\begin{eulerprompt}
>&remvalue(a,b,c,r); // hapus nilai-nilai sebelumnya untuk perhitungan baru
>rabc &= rhs(solve(triplespread(spread(b,r,r),spread(a,r,r),spread(c,r,r)),r)[4]); $rabc
\end{eulerprompt}
...
>title="If you see ellipses, please set your window square"):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-180.png}
\begin{eulercomment}
dan grafiknya juga agak sederhana: bagian atas kerucut:
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d1",xmin=-2,xmax=0,ymin=-2,ymax=0):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-181.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-182.png}
\begin{eulercomment}
Grafiknya lebih menarik:
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-183.png}
\begin{eulercomment}
Pembatasan garis (AB) lebih terkenal:
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-184.png}
\eulersubheading{Tiga poin}
\begin{eulercomment}
Contoh:
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-185.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-186.png}
\begin{eulercomment}
...
>plot3d("d3",xmin=-2,xmax=2,ymin=-2,ymax=2):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-187.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-188.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Empat poin}
\begin{eulercomment}
...
>plot3d("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-189.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-190.png}
\eulersubheading{Contoh 7: Bola Dandelin dengan Povray}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerprompt}
...
>a:=2; color(blue); plotLine(g1(),""), plotLine(g2(),""):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-191.png}
\begin{eulercomment}
Sekarang kita ambil titik umum pada sumbu y.
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-195.png}
\eulersubheading{Latihan}
\begin{eulercomment}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-196.png}
\begin{eulerprompt}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-197.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-198.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-199.png}
\begin{eulercomment}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-200.png}
\begin{eulerprompt}
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-201.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-202.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-203.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-204.png}
\begin{eulercomment}
Batasan ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-205.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-206.png}
\begin{eulercomment}
Grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-207.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/5. Ghefira Nur Annisa_22305144034 (Geometri)-208.png}
\end{eulernotebook}
\end{document}
